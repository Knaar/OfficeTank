...
// End Cross Module References
	...
	template<> TANK_API UClass* StaticClass<UDamageTaker>()
	{
		return UDamageTaker::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UDamageTaker);
	struct Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_DamageTaker_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_DamageTaker_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDamageTaker, UDamageTaker::StaticClass, TEXT("UDamageTaker"), &Z_Registration_Info_UClass_UDamageTaker, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageTaker), 4191389099U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_DamageTaker_h_87848869(TEXT("/Script/Tank"),
		Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_DamageTaker_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_DamageTaker_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
