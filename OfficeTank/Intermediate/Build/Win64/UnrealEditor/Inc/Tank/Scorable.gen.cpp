...
// End Cross Module References
	...
	template<> TANK_API UClass* StaticClass<UScorable>()
	{
		return UScorable::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UScorable);
	struct Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_Scorable_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_Scorable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UScorable, UScorable::StaticClass, TEXT("UScorable"), &Z_Registration_Info_UClass_UScorable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScorable), 1521670676U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_Scorable_h_1559781831(TEXT("/Script/Tank"),
		Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_Scorable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_Scorable_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
