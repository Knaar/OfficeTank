...
#define FID_OfficeTank_Source_Tank_TankPawn_h_16_DELEGATE \
static inline void FOnGameOver_DelegateWrapper(const FMulticastScriptDelegate& OnGameOver) \
{ \
	OnGameOver.ProcessMulticastDelegate<UObject>(NULL); \
}


#define FID_OfficeTank_Source_Tank_TankPawn_h_21_SPARSE_DATA
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_RPC_WRAPPERS \
 \
...
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_RPC_WRAPPERS_NO_PURE_DECLS \
 \
	DECLARE_FUNCTION(execRotateTurretTo); \
	DECLARE_FUNCTION(execGetTurretForwardVector); \
	DECLARE_FUNCTION(execGetMovementAccurency); \
...
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_INCLASS \
private: \
	static void StaticRegisterNativesATankPawn(); \
	friend struct Z_Construct_UClass_ATankPawn_Statics; \
public: \
...
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_STANDARD_CONSTRUCTORS \
...
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_ENHANCED_CONSTRUCTORS \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ATankPawn(ATankPawn&&); \
	NO_API ATankPawn(const ATankPawn&); \
...
#define FID_OfficeTank_Source_Tank_TankPawn_h_21_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_OfficeTank_Source_Tank_TankPawn_h_21_SPARSE_DATA \
...
template<> TANK_API UClass* StaticClass<class ATankPawn>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_OfficeTank_Source_Tank_TankPawn_h
