...
#include "Tank/AmmoBox.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeAmmoBox() {}
// Cross Module References
	TANK_API UClass* Z_Construct_UClass_AAmmoBox_NoRegister();
	TANK_API UClass* Z_Construct_UClass_AAmmoBox();
...
// End Cross Module References
	...
	template<> TANK_API UClass* StaticClass<AAmmoBox>()
	{
		return AAmmoBox::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AAmmoBox);
	struct Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_AmmoBox_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_AmmoBox_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AAmmoBox, AAmmoBox::StaticClass, TEXT("AAmmoBox"), &Z_Registration_Info_UClass_AAmmoBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAmmoBox), 2004498463U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_AmmoBox_h_1877292170(TEXT("/Script/Tank"),
		Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_AmmoBox_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OfficeTank_Source_Tank_AmmoBox_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
